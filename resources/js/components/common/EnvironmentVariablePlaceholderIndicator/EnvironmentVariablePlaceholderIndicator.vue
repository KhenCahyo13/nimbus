        ...
        >
            <template v-if="status === EnvironmentPlaceholderStatus.Missing">
                ...
                <p class="text-muted-foreground text-xs">
                    This field contains a placeholder referencing a variable that is not defined
                    in the active environment collection.
                </p>
            </template>
            ...
            <template v-else-if="status === EnvironmentPlaceholderStatus.Empty">
                ...
                <p class="text-muted-foreground text-xs">
                    This field contains a placeholder referencing a variable that exists but has
                    no value set.
                </p>
            </template>
            ...
            <template v-else-if="status === EnvironmentPlaceholderStatus.Resolved">
                ...
                <p class="text-muted-foreground text-xs">
                    All placeholders in this field have been resolved from the active environment
                    collection.
                </p>
            </template>
        </AppPopoverContent>
